...
ALTER TABLE computer_staff
    ADD PRIMARY KEY (serial_number, staff_id); -- added serial_number
...
ALTER TABLE computer_staff
    ADD CONSTRAINT computer_staff_serial_number_fk  -- fixed name
        FOREIGN KEY (serial_number)
        REFERENCES computer (serial_number)
        ON DELETE CASCADE;
        
ALTER TABLE computer_staff
    ADD CONSTRAINT computer_staff_staff_id_fk -- fixed name
